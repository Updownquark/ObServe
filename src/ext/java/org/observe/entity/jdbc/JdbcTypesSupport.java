...
import org.observe.entity.jdbc.JdbcTypesSupport.JdbcColumn.BooleanColumnType;
...
public class JdbcTypesSupport {
	public interface JdbcTypeSupport<T> {
		<T2 extends T> JdbcColumn<T2> columnFor(TypeToken<T2> type, int columnType, JdbcTypesSupport support);

		int getDefaultColumnType(TypeToken<? extends T> fieldType);

		public static final JdbcTypeSupport<Integer> INT = new JdbcTypeSupport<Integer>() {
			@Override
			public <T2 extends Integer> JdbcColumn<T2> columnFor(TypeToken<T2> type, int columnType, JdbcTypesSupport support) {
				switch (columnType) {
				case Types.INTEGER:
				case Types.BIGINT:
			...
			@Override
			public int getDefaultColumnType(TypeToken<? extends Integer> fieldType) {
		...
		public static final JdbcTypeSupport<Long> LONG = new JdbcTypeSupport<Long>() {
			@Override
			public <T2 extends Long> JdbcColumn<T2> columnFor(TypeToken<T2> type, int columnType, JdbcTypesSupport support) {
				switch (columnType) {
				case Types.INTEGER:
				case Types.BIGINT:
			...
			@Override
			public int getDefaultColumnType(TypeToken<? extends Long> fieldType) {
				return Types.BIGINT;
			}
		};
		...
		public static final JdbcTypeSupport<Double> DOUBLE = new JdbcTypeSupport<Double>() {
			@Override
			public <T2 extends Double> JdbcColumn<T2> columnFor(TypeToken<T2> type, int columnType, JdbcTypesSupport support) {
				switch (columnType) {
				case Types.DOUBLE:
				case Types.FLOAT:
				case Types.NUMERIC:
			...
			@Override
			public int getDefaultColumnType(TypeToken<? extends Double> fieldType) {
				return Types.DOUBLE;
			}
		};
		...
		public static final JdbcTypeSupport<String> STRING = new JdbcTypeSupport<String>() {
			@Override
			public <T2 extends String> JdbcColumn<T2> columnFor(TypeToken<T2> type, int columnType, JdbcTypesSupport support) {
				switch (columnType) {
				case Types.CHAR:
				case Types.VARCHAR:
				case Types.CLOB:
			...
			@Override
			public int getDefaultColumnType(TypeToken<? extends String> fieldType) {
		...
		public static final JdbcTypeSupport<Boolean> BOOLEAN = new JdbcTypeSupport<Boolean>() {
			@Override
			public <T2 extends Boolean> JdbcColumn<T2> columnFor(TypeToken<T2> type, int columnType, JdbcTypesSupport support) {
				switch (columnType) {
				case Types.BOOLEAN:
			...
			@Override
			public int getDefaultColumnType(TypeToken<? extends Boolean> fieldType) {
		...
		public static final JdbcTypeSupport<Instant> INSTANT = new JdbcTypeSupport<Instant>() {
			@Override
			public <T2 extends Instant> JdbcColumn<T2> columnFor(TypeToken<T2> type, int columnType, JdbcTypesSupport support) {
				switch (columnType) {
			...
			@Override
			public int getDefaultColumnType(TypeToken<? extends Instant> fieldType) {
		...
		public static final JdbcTypeSupport<Duration> DURATION = new JdbcTypeSupport<Duration>() {
			@Override
			public <T2 extends Duration> JdbcColumn<T2> columnFor(TypeToken<T2> type, int columnType, JdbcTypesSupport support) {
				switch (columnType) {
				case Types.INTEGER:
				case Types.BIGINT:
			...
			@Override
			public int getDefaultColumnType(TypeToken<? extends Duration> fieldType) {
				return Types.DOUBLE;
			}
		};
		...
		public static final JdbcTypeSupport<Collection<?>> COLLECTION = new JdbcTypeSupport<Collection<?>>() {
			@Override
			public <T2 extends Collection<?>> JdbcColumn<T2> columnFor(TypeToken<T2> type, int columnType,
				JdbcTypesSupport support) {
			...
			@Override
			public int getDefaultColumnType(TypeToken<? extends Collection<?>> fieldType) {
				return Types.VARCHAR;
			}
		};
	}
	...
	private static class ColumnSupportHolder<T> {
		...
		<F extends T> JdbcColumn<F> getColumn(TypeToken<F> type, int columnType, JdbcTypesSupport allSupport) {
			if (theType.isAssignableFrom(TypeTokens.get().wrap(type))) {
				return support.columnFor(type, columnType != Integer.MIN_VALUE ? columnType : support.getDefaultColumnType(type),
					allSupport);
			} else
				return null;
		}
	...
	public static class Builder {
		...
		public Builder support(JdbcTypesSupport support) {
			theColumnSupport.addAll(support.getColumnSupport());
			return this;
		}

		public JdbcTypesSupport build() {
			return new JdbcTypesSupport(theAutoIncrement, theColumnSupport);
		}
	}
	...
	public JdbcTypesSupport(String autoIncrement, List<ColumnSupportHolder<?>> columnSupport) {
		theAutoIncrement = autoIncrement;
	...
	public <F> JdbcColumn<F> getColumnSupport(TypeToken<F> type) {
		return getColumnSupport(type, Integer.MIN_VALUE);
	}

	public <F> JdbcColumn<F> getColumnSupport(TypeToken<F> type, int columnType) {
		type = TypeTokens.get().wrap(type);
		for (ColumnSupportHolder<?> holder : theColumnSupport) {
			if (!holder.theType.isAssignableFrom(type))
				continue;
			JdbcColumn<F> column = ((ColumnSupportHolder<? super F>) holder).getColumn(type, columnType, this);
			if (column != null)
				return column;
		}
