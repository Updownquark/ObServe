...
public class ObservableMultiMapEvent<K, V> extends ObservableMapEvent<K, V> {
	 ...
	 */
	public ObservableMultiMapEvent(ElementId keyElementId, ElementId valueElementId, TypeToken<K> keyType, TypeToken<V> valueType, int keyIndex,
		int valueIndex, CollectionChangeType type, K key, V oldValue, V newValue, Object cause) {
		super(valueElementId, keyType, valueType, valueIndex, type, key, oldValue, newValue, cause);
