 ...
 *
 * @param <E> The type of styled element this add-on can be applied to
 * @param <AO> The sub-type of add-on to create
 */
public interface QuickStyledAddOn<E extends ExElement, AO extends ExAddOn<? super E>> extends ExAddOn.Def<E, AO> {
