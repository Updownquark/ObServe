...
public interface ModelValueElement<M, MV extends M> extends ExElement {
	...
	public interface Def<M, E extends ModelValueElement<M, ?>> extends ExElement.Def<E> {
		...
		public abstract class Ext<M, E extends ModelValueElement<M, ?>> extends Simple<M, E> implements ExtModelValue<M> {
			protected Ext(ExElement.Def<?> parent, QonfigElement element, ModelType<M> modelType, String toolkitName,
				Version toolkitVersion, String typeName) {
				super(parent, element, modelType, toolkitName, toolkitVersion, typeName);
			}
		}

		public class ExtSingle<M, E extends ModelValueElement<M, ?>> extends Ext<M, E> {
			private final VariableType theValueType;

			public ExtSingle(ExElement.Def<?> parent, QonfigElement element, ModelType.SingleTyped<M> modelType, VariableType valueType,
		...
		public class ExtDouble<M, E extends ModelValueElement<M, ?>> extends Ext<M, E> {
			private final VariableType theValueType1;
			private final VariableType theValueType2;

			public ExtDouble(ExElement.Def<?> parent, QonfigElement element, ModelType.DoubleTyped<M> modelType, VariableType valueType1,
