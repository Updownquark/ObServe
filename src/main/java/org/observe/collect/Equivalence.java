...
public interface Equivalence<E> {
	...
	class MappedEquivalence<E, T> implements Equivalence<T> {
		...
		@Override
		public <E2 extends T> Set<E2> createSet() {
			return new MappedSet<>(this, theWrapped.createSet(), theMap, theReverse);
		}

		@Override
		public <E2 extends T, V> Map<E2, V> createMap() {
		...
		public boolean equals(Object o) {
			...
			return equiv.theWrapped.equals(theWrapped) && equiv.theType.equals(theType) && equiv.theFilter == theFilter
				&& equiv.theReverse.equals(theReverse);
		}
	}

	class MappedSet<E, T, T2 extends T> extends AbstractSet<T2> {
		private final MappedEquivalence<E, T> theEquivalence;
		private final Set<E> theWrapped;
		private final Function<? super E, ? extends T> theMap;
		private final Function<? super T, ? extends E> theReverse;

		public MappedSet(MappedEquivalence<E, T> equiv, Set<E> wrapped, Function<? super E, ? extends T> map,
			Function<? super T, ? extends E> reverse) {
	...
	class MappedMap<E, T, T2 extends T, V> extends AbstractMap<T2, V> {
		private final MappedEquivalence<E, T> theEquivalence;
		private final Map<E, V> theWrapped;
		private final Function<? super E, ? extends T> theMap;
		private final Function<? super T, ? extends E> theReverse;

		public MappedMap(MappedEquivalence<E, T> equiv, Map<E, V> wrapped, Function<? super E, ? extends T> map,
			Function<? super T, ? extends E> reverse) {
			theEquivalence = equiv;
			theWrapped = wrapped;
			theMap = map;
