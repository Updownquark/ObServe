...
public class CsvEntitySetTest {
	...
	public void testBasic() {
		...
		try {
			entitySet = CsvEntitySetTestUtils.createSimpleEntitySet(dir);
			for (int i = 0; i < 5; i++)
				CsvEntitySetTestUtils.addTestEntity(entitySet, i * 10);
			...
			CsvEntitySetTestUtils.addTestEntity(entitySet, 35);
	...
	static class CsvEntityTestable implements Testable {
		...
		public void accept(TestHelper helper) {
			...
			try {
				entitySet[0] = CsvEntitySetTestUtils.createSimpleEntitySet(dir);
			} catch (IOException e) {
				throw new CheckedExceptionWrapper(e);
			}
			try {
